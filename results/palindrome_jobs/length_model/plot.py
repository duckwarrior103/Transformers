"""Plot palindrome length_model sweep results — all models x sequence lengths.
...
def main():
    ...
    if all_model_finals:
        ...
        plot_comparison(all_model_finals, graphs_dir, "token_acc", "Token Accuracy (%)",
                        "Palindrome — Model Comparison — Token Accuracy vs Seq Length (teacher-forced)",
    ...
    if tdf is not None:
        ...
        if "final_token_acc" in tdf.columns:
            plot_test_comparison(tdf, graphs_dir, "final_token_acc", "Token Accuracy (%)",
                                 "Palindrome — Model Comparison — Token Accuracy vs Seq Length (generate)",
    ...
    if all_model_epochs:
        ...
        plot_convergence(all_model_epochs, graphs_dir, "token_acc", "Token Accuracy (%)",
                         "Palindrome — Token Accuracy", "convergence_token_acc.png", scale=100)
        plot_convergence(all_model_epochs, graphs_dir, "exact_acc", "Exact Accuracy (%)",
                         "Palindrome — Exact Accuracy", "convergence_exact_acc.png", scale=100)
